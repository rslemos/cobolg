...
import br.eti.rslemos.cobolg.COBOLParser.StmtPageWRITEimperativeContext;

public class StmtPageWRITEimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtPageWRITEimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtPageWRITEimperativeContext> helper = new CompilerHelper<StmtPageWRITEimperativeContext>() {
		@Override protected StmtPageWRITEimperativeContext parsePart() { return parser.stmtPageWRITEimperative(); }
	};
