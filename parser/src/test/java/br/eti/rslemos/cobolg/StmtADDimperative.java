...
import br.eti.rslemos.cobolg.COBOLParser.StmtADDimperativeContext;

public class StmtADDimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtADDimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtADDimperativeContext> helper = new CompilerHelper<StmtADDimperativeContext>() {
		@Override protected StmtADDimperativeContext parsePart() { return parser.stmtADDimperative(); }
	};
