...
public class StmtCOMPUTEimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtCOMPUTEimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtCOMPUTEimperativeContext> helper = new CompilerHelper<StmtCOMPUTEimperativeContext>() {
		@Override protected StmtCOMPUTEimperativeContext parsePart() { return parser.stmtCOMPUTEimperative(); }
	};
