...
import br.eti.rslemos.cobolg.COBOLParser.StmtMULTIPLYimperativeContext;

public class StmtMULTIPLYimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtMULTIPLYimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtMULTIPLYimperativeContext> helper = new CompilerHelper<StmtMULTIPLYimperativeContext>() {
		@Override protected StmtMULTIPLYimperativeContext parsePart() { return parser.stmtMULTIPLYimperative(); }
	};
