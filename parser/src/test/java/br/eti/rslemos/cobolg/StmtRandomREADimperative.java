...
import br.eti.rslemos.cobolg.COBOLParser.StmtRandomREADimperativeContext;

public class StmtRandomREADimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtRandomREADimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtRandomREADimperativeContext> helper = new CompilerHelper<StmtRandomREADimperativeContext>() {
		@Override protected StmtRandomREADimperativeContext parsePart() { return parser.stmtRandomREADimperative(); }
	};
