...
import br.eti.rslemos.cobolg.COBOLParser.StmtINVOKEimperativeContext;
import br.eti.rslemos.cobolg.Waive.CompilationError;

@Waive({CompilationError.EXACT_AMBIGUITY, CompilationError.FULL_CONTEXT_ATTEMPT})
public class StmtINVOKEimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtINVOKEimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtINVOKEimperativeContext> helper = new CompilerHelper<StmtINVOKEimperativeContext>() {
		@Override protected StmtINVOKEimperativeContext parsePart() { return parser.stmtINVOKEimperative(); }
	};
