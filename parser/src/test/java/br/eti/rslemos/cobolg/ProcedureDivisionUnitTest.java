...
public class ProcedureDivisionUnitTest {
	...
	@Test public void PROCEDURE_DIVISION_STOP_RUN_PARAGRAPH_B_STOP_RUN_SECTION_1_SECTION_PARAGRAPH_C_STOP_RUN_PARAGRAPH_A_STOP_RUN() {
		helper.compileAndVerify(
				get("PROCEDURE_DIVISION_STOP_RUN_PARAGRAPH_B_STOP_RUN_SECTION_1_SECTION_PARAGRAPH_C_STOP_RUN_PARAGRAPH_A_STOP_RUN.source"),
				get("PROCEDURE_DIVISION_STOP_RUN_PARAGRAPH_B_STOP_RUN_SECTION_1_SECTION_PARAGRAPH_C_STOP_RUN_PARAGRAPH_A_STOP_RUN.tree")
			);
	}
	...
	@Test public void PROCEDURE_DIVISION_RETURNING_RESULT_STOP_RUN() {
		helper.compileAndVerify(
				get("PROCEDURE_DIVISION_RETURNING_RESULT_STOP_RUN.source"),
				get("PROCEDURE_DIVISION_RETURNING_RESULT_STOP_RUN.tree")
			);
	}
	
	@Waive({CompilationError.EXACT_AMBIGUITY, CompilationError.FULL_CONTEXT_ATTEMPT})
	@Test public void PROCEDURE_DIVISION_USING_DATA_1_DATA_2_RETURNING_RESULT_STOP_RUN() {
		helper.compileAndVerify(
				get("PROCEDURE_DIVISION_USING_DATA_1_DATA_2_RETURNING_RESULT_STOP_RUN.source"),
				get("PROCEDURE_DIVISION_USING_DATA_1_DATA_2_RETURNING_RESULT_STOP_RUN.tree")
			);
	}
}
