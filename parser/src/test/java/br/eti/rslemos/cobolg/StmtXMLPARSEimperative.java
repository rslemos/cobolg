...
import br.eti.rslemos.cobolg.COBOLParser.StmtXMLPARSEimperativeContext;
import br.eti.rslemos.cobolg.Waive.CompilationError;

@Waive({CompilationError.EXACT_AMBIGUITY, CompilationError.FULL_CONTEXT_ATTEMPT})
public class StmtXMLPARSEimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtXMLPARSEimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtXMLPARSEimperativeContext> helper = new CompilerHelper<StmtXMLPARSEimperativeContext>() {
		@Override protected StmtXMLPARSEimperativeContext parsePart() { return parser.stmtXMLPARSEimperative(); }
	};
