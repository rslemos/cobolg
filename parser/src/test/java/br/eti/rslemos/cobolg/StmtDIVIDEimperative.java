...
import br.eti.rslemos.cobolg.COBOLParser.StmtDIVIDEimperativeContext;

public class StmtDIVIDEimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtDIVIDEimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtDIVIDEimperativeContext> helper = new CompilerHelper<StmtDIVIDEimperativeContext>() {
		@Override protected StmtDIVIDEimperativeContext parsePart() { return parser.stmtDIVIDEimperative(); }
	};
