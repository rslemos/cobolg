...
import br.eti.rslemos.cobolg.COBOLParser.StmtSTRINGimperativeContext;

public class StmtSTRINGimperative {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtSTRINGimperative");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtSTRINGimperativeContext> helper = new CompilerHelper<StmtSTRINGimperativeContext>() {
		@Override protected StmtSTRINGimperativeContext parsePart() { return parser.stmtSTRINGimperative(); }
	};
