...
import br.eti.rslemos.cobolg.COBOLParser.StmtXMLPARSEdelimitedScopeContext;
import br.eti.rslemos.cobolg.Waive.CompilationError;

@Waive({CompilationError.EXACT_AMBIGUITY, CompilationError.FULL_CONTEXT_ATTEMPT})
public class StmtXMLPARSEdelimitedScope {
	private static final ResourceBundle TEST_DATA = ResourceBundle.getBundle("br.eti.rslemos.cobolg.stmtXMLPARSEdelimitedScope");
	public static String get(String key) { return TEST_DATA.getString(key); }

	private static CompilerHelper<StmtXMLPARSEdelimitedScopeContext> helper = new CompilerHelper<StmtXMLPARSEdelimitedScopeContext>() {
		@Override protected StmtXMLPARSEdelimitedScopeContext parsePart() { return parser.stmtXMLPARSEdelimitedScope(); }
	};
